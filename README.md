# branch1 - Допкоммит3: последнее изменение в branch 1
# branch1 - Допкоммит2: еще одно новое изменение
# branch1 - Дпкоммит1: новое изменение после слияния
# branch1 - Коммит 3: Последнее изменение в branch1
